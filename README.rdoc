...
Predecessor to 90kts:watir-webdriver-performance[https://github.com/90kts/watir-webdriver-performance] for Watir as opposed to watir-webdriver.
...
Copyright (c) 2017 Robert MacCracken, 2011 Tim Koopmans
